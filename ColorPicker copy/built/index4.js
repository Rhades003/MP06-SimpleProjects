...
es tipo any*/
let diners = parseFloat(prompt("Cuantos dineros tienes?"));
let introProduct = prompt("Quieres añadir un producto(Si/No)?");
...
switch (introProduct) {
    case "Si": {
        ...
        do {
            ...
            nameProduct = prompt("Cuál es el nombre del producto?");
            priceProduct = parseFloat(prompt("Cuál es el precio del producto?"));
            quantity = parseInt(prompt("Cuál es la cantidad que deseas?"));
            preguntaFinish = prompt("El producto es correcto(Si/No en caso de que no se repetirá el proceso de preguntas)?");
